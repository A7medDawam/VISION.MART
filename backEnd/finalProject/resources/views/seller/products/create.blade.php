...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{route('seller.products.store')}}" method="post" enctype="multipart/form-data">
          @csrf
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (!imageInput || !categorySelect || !resultDiv) return;
        ...
        imageInput.addEventListener('change', async function () {
            ...
            try {
                ...
                console.error(err);
                resultDiv.innerHTML = "❌ AI failed. Please select category manually.";
            }
        });
    });
  </script>
